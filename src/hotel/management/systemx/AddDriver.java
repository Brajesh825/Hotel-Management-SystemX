...
public class AddDriver extends JFrame implements ActionListener{
    ...
    public AddDriver() {
        setBounds(450, 200, 910, 485);
	setLayout(null);
        setTitle("Add drivers");
        
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/systemx/icons/adddriver.jpg"));
                Image i3 = i1.getImage().getScaledInstance(500, 450,Image.SCALE_SMOOTH);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l15 = new JLabel(i2);
                l15.setBounds(400,0,500,450);
                add(l15);
